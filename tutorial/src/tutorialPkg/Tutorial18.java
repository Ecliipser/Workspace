...
public class Tutorial18 {
	...
	public static void main(String[] args) {
		...
		final double TAX = 0.05; //tax for price
	...
	do {	
		...
		else if(itemNum == 1) { //This if statement is if the user picks option 1
		...
		price = bowieKnifePrice * qty;//This is a price variable that is being called that the bowieKnifePrice is going to be multiplied to how many the user want which is the quantity
			...
			System.out.println("Tax is: " + price * TAX); // prints out the price with the tax
			double totalPrice = price * TAX + price; //price multiplied with tax plus price is added again with tax
			System.out.println("Total tax is: " + totalPrice); //prints out total price
